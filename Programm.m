function varargout = Programm(varargin)
% PROGRAMM MATLAB code for Programm.fig
%      PROGRAMM, by itself, creates a new PROGRAMM or raises the existing
%      singleton*.
%
%      H = PROGRAMM returns the handle to a new PROGRAMM or the handle to
%      the existing singleton*.
%
%      PROGRAMM('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PROGRAMM.M with the given input arguments.
%
%      PROGRAMM('Property','Value',...) creates a new PROGRAMM or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Programm_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Programm_OpeningFcn via varargin.
%
...
% --- Executes just before Programm is made visible.
function Programm_OpeningFcn(hObject, ~, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Programm (see VARARGIN)

% Choose default command line output for Programm
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes Programm wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = Programm_OutputFcn(~, ~, handles) 
...
close(handles.ib)
set(handles.edit12,'string','Disconnected');
...
% --- Executes on button press in Output2.
function Output2_Callback(hObject, eventdata, handles)
% hObject    handle to Output2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of Output2


% --- Executes on button press in Output3.
function Output3_Callback(hObject, eventdata, handles)
% hObject    handle to Output3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of Output3


% --- Executes on button press in Output4.
function Output4_Callback(hObject, eventdata, handles)
% hObject    handle to Output4 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of Output4


% --- Executes on button press in Output5.
function Output5_Callback(hObject, eventdata, handles)
% hObject    handle to Output5 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of Output5


% --- Executes on button press in Output6.
function Output6_Callback(hObject, eventdata, handles)
% hObject    handle to Output6 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of Output6


% --- Executes on button press in Output7.
function Output7_Callback(hObject, eventdata, handles)
% hObject    handle to Output7 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of Output7


% --- Executes on button press in Output8.
function Output8_Callback(hObject, eventdata, handles)
% hObject    handle to Output8 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of Output8
...
% Hint: get(hObject,'Value') returns toggle state of Input2
...
% Hint: get(hObject,'Value') returns toggle state of Input3
...
% Hint: get(hObject,'Value') returns toggle state of Input4
...
% Hint: get(hObject,'Value') returns toggle state of Input5
...
% Hint: get(hObject,'Value') returns toggle state of Input6
...
% Hint: get(hObject,'Value') returns toggle state of Input7
